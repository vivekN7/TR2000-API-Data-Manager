-- ===============================================================================
-- TR2000_UTIL Package from DBA
-- Date: 2025-08-27
-- Purpose: Centralized utility package for API calls with APEX credentials
-- Note: This package should be created by DBA in a central schema
-- ===============================================================================

-- This package uses AUTHID DEFINER to run with owner's privileges
-- DBA should create this in a dedicated schema (e.g., TR2000_ADMIN)
