-- Restore PKG_ETL_PROCESSOR with proper implementations
-- Following data flow: API → RAW_JSON → STG_* → Core Tables
-- Date: 2025-09-05
...
CREATE OR REPLACE PACKAGE BODY PKG_ETL_PROCESSOR AS
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_procedure_name => 'parse_and_load_pcs_references',
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_vds_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_mds_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_eds_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_vsk_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_esk_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_pipe_element_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_sc_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_vsm_references',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    BEGIN
        ...
        -- Format 1: $.getPlantPcsList[*]
        IF JSON_EXISTS(v_json, '$.getPlantPcsList') THEN
            ...
            FROM JSON_TABLE(v_json, '$.getPlantPcsList[*]'
                COLUMNS (
                    PCS VARCHAR2(100) PATH '$.PCS',
                    Revision VARCHAR2(50) PATH '$.Revision',
                    Status VARCHAR2(50) PATH '$.Status',
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_pcs_list',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_pcs_details',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ...
            PKG_ETL_LOGGING.log_error(
                ...
                p_error_message => v_error_msg,
                p_procedure_name => 'parse_and_load_vds_catalog',
                p_raw_json_id => p_raw_json_id
            );
            RAISE;
...
SHOW ERRORS PACKAGE BODY PKG_ETL_PROCESSOR;

-- Count procedures in the package
SELECT COUNT(*) AS procedure_count
FROM user_procedures
WHERE object_name = 'PKG_ETL_PROCESSOR'
AND procedure_name IS NOT NULL;

PROMPT Package PKG_ETL_PROCESSOR restored successfully