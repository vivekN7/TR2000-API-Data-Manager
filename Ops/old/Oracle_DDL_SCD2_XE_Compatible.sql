-- =====================================================
-- TR2000 STAGING DATABASE - SCD TYPE 2 (XE COMPATIBLE)
-- Database: Oracle XE
-- Schema: TR2000_STAGING
-- Version: SCD2 XE - Hash computed in application layer
-- Updated: 2025-08-17
-- 
-- NOTE: Oracle XE doesn't have STANDARD_HASH or ORA_HASH
-- So we compute hashes in C# and store them as VARCHAR2
-- =====================================================
...
BEGIN
    ...
    -- Drop all functions (cleanup from previous attempts)
...
CREATE TABLE STG_OPERATORS (
    ...
    SRC_HASH           VARCHAR2(64),  -- Hash computed in C#
    ETL_RUN_ID         NUMBER
);
...
CREATE TABLE OPERATORS (
    ...
    OPERATOR_ID        NUMBER NOT NULL,
    OPERATOR_NAME      VARCHAR2(200),
    SRC_HASH           VARCHAR2(64),  -- Hash from C#
...
-- =====================================================
-- STEP 8: NO HASH FUNCTIONS (Computed in C#)
-- =====================================================
-- Oracle XE doesn't have STANDARD_HASH or ORA_HASH
-- So we compute SHA256 hashes in the C# application layer
-- This is actually more portable and can be consistent
-- across different Oracle versions
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('✓ Hash computed in C# application (SHA256)');
    DBMS_OUTPUT.PUT_LINE('✓ Compatible with Oracle XE');
    DBMS_OUTPUT.PUT_LINE('✓ Staging tables for ETL processing');
    DBMS_OUTPUT.PUT_LINE('✓ Performance indexes on all key columns');
    DBMS_OUTPUT.PUT_LINE('===============================================');
    DBMS_OUTPUT.PUT_LINE('');
    DBMS_OUTPUT.PUT_LINE('NOTE: Hashes are computed in the application layer');
    DBMS_OUTPUT.PUT_LINE('This ensures consistency across Oracle versions');
    DBMS_OUTPUT.PUT_LINE('===============================================');
END;
/

-- Quick verification queries
SELECT 'Current Statistics:' as INFO FROM DUAL;
SELECT * FROM V_ETL_STATISTICS;

SELECT 'Plant Loader Configuration:' as INFO FROM DUAL;
SELECT * FROM ETL_PLANT_LOADER;