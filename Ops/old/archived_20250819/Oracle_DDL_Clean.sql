...
-- Drop Views
DROP VIEW VW_CURRENT_PCS CASCADE CONSTRAINTS;
DROP VIEW VW_CURRENT_ISSUES CASCADE CONSTRAINTS;
DROP VIEW VW_CURRENT_PLANTS CASCADE CONSTRAINTS;
DROP VIEW VW_CURRENT_OPERATORS CASCADE CONSTRAINTS;

-- Drop Reference Tables
DROP TABLE PIPE_ELEMENT_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE ESK_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE VSK_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE MDS_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE EDS_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE VDS_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE VSM_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE SC_REFERENCES CASCADE CONSTRAINTS;
DROP TABLE PCS_REFERENCES CASCADE CONSTRAINTS;

-- Drop List Tables
DROP TABLE VDS_LIST CASCADE CONSTRAINTS;
DROP TABLE PCS_LIST CASCADE CONSTRAINTS;
...
DROP TABLE ETL_ERROR_LOG CASCADE CONSTRAINTS;
DROP TABLE ETL_ENDPOINT_LOG CASCADE CONSTRAINTS;
DROP TABLE ETL_CONTROL CASCADE CONSTRAINTS;
...
-- UNION ALL
-- SELECT 'PLANTS', COUNT(*) 
-- FROM PLANTS WHERE IS_CURRENT = 'Y'
-- UNION ALL
-- SELECT 'ISSUES', COUNT(*) 
-- FROM ISSUES WHERE IS_CURRENT = 'Y';
